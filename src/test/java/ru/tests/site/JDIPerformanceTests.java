...
import static ru.tests.uiobjects.data.TestData.TABLE_SNAPSHOOT;
import static ru.tests.uiobjects.site.SiteJdi.performancePage;
import static ru.tests.uiobjects.site.pages.JDIPerformancePage.*;
